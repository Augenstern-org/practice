...
def check_exam_constraints():
    ...
    if not constraint4:
        ...
        print(f'THE FINAL GRADE IS LESS THAN 7: {COL["RED"]}EXAM NOT PASSED{COL["RST"]}')
    else:
    ...
    print(f"Total >= 7:                 {COL['BOLD']} {COL['GREEN'] if constraint3 else COL['RED']} {constraint3}{COL['RST']}{COL['ENDC']}")
